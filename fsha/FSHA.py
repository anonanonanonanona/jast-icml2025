...
class FSHA:
    ...
    def __init__(self, xpriv, xpub, id_setup, batch_size, hparams, architecture="mlp"):
            assert architecture in ["mlp", "cnn"], "Wrong models architecture. Valid options are 'mlp' and 'cnn'."
            ...
            ## setup models
            architecture_setup = architectures.SETUPS_mlp if architecture == "mlp" else architectures.SETUPS_cnn
            make_f, make_tilde_f, make_decoder, make_D = architecture_setup[id_setup]
